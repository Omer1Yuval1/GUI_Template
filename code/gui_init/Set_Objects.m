function Set_Objects(P)
	...
	lx = 0.2;
	px = [0.02,0.25,[0.5,0.65,0.85]-0.05];
	...
	for i=1:4
		...
		P.GUI_Handles.Control_Panel_Objects(i,2) = uicontrol(P.GUI_Handles.Radio_Group_1,'Style','radio','UserData',i,'Units','Normalized','Position',[px(2),py,lx+0.01,y],'ForegroundColor',[1,1,1],'Backgroundcolor',P.GUI_Handles.BG_Color_1,'FontSize',12,'String',['Radio Text',num2str(i)],'Enable','off');
